...
global.namebot = 'Nana V2ラ'
global.nameown = 'ᴹᴿ᭄ Leon ×፝֟͜×'


/*============== STAFF ==============*/
global.owner = [
  ['6287760550924', 'ᴹᴿ᭄ Leon ×፝֟͜×', 'true']
...
/*============== WATERMARK ==============*/
global.wm = 'Nana Chamラ | By ᴹᴿ᭄ Leon ×፝֟͜×' //Main Watermark
global.wm2 = 'ᴹᴿ᭄ Leon ×፝֟͜×'
global.wm3 = 'Nana Chanラ | By ᴹᴿ᭄ Leon ×፝֟͜×'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `Nana Chanラ | ʙʏ ${global.nameown}`
global.author = 'ᴹᴿ᭄ Leon ×፝֟͜×' 
global.packname = 'ᴹᴿ᭄ Leon ×፝֟͜×'
...
/*============== GLOBAL BIO ==============*/
global.nameowner = 'ᴹᴿ᭄ Leon ×፝֟͜×'
global.umurowner = '22'
global.asalowner = 'Indonesia, Makassar'
